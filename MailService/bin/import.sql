...
INSERT INTO account (user_id,smtp_address,smtp_port,in_server_type,in_server_address,in_server_port,username,password,display_name) VALUES (2,'smtpAdresa2',568,2,'nesti',538,'b', 'b','user2');
